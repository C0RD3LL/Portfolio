...
The results concluded that samtools performed faster then the rest probably most likely becuase of its high memory usage. It was also noted that bioperl was signifcantly slower to generate and index than others and that memory was consisently between 17,000 ~ 18,000 regardless of file size.
